...
void HAL_UART_RxCpltCallback(UART_HandleTypeDef *huart)
{
    ...
    {
        if (mavlink_parse_char(mavlinkMsg.Rx.chan, mavlinkMsg.Rx.RxChannel, &mavlinkMsg.Rx.msg, &mavlinkMsg.Rx.statu))
        {
    ...
    HAL_UART_Receive_IT(mavlinkMsg.huart, &mavlinkMsg.Rx.RxChannel, 1);
}
